...
save_classifier() {
    ...
    log_dir=${code_dir}/experiments/ego_gesture/mi_drop/seed_${seed}/task_${cur_task_id}
    inverted_data_dir=${code_dir}/experiments/ego_gesture/mi_drop/seed_${seed}/task_${prev_task_id}/${inverted_data_subdir}
